...
struct SimParameters {
   ...
   SimParameters() {}
    ...
    // Add copy constructor for safety
    SimParameters(const SimParameters& other) {
        memcpy(nozzle_origin, other.nozzle_origin, sizeof(float) * 3);
        memcpy(nozzle_initial_acceleration, other.nozzle_initial_acceleration, sizeof(float) * 3);
        memcpy(nozzle_initial_velocity, other.nozzle_initial_velocity, sizeof(float) * 3);
        nozzle_velocity_spread = other.nozzle_velocity_spread;
        nozzle_acceleration_spread = other.nozzle_acceleration_spread;
        nozzle_angle = other.nozzle_angle;
        nozzle_flow_rate = other.nozzle_flow_rate;
    }
